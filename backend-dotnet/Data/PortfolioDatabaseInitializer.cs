            ...
            if (!await context.PortfolioProjects.AnyAsync())
            {
                context.PortfolioProjects.AddRange(
                    new PortfolioProject
                    {
                        ...
                        GalleryJson = JsonGallery(("image", "/media/placeholders/project-uiux.webp", "Neutral UI UX placeholder for Peduli Donasi", "Replace with real app screens or Figma export.")),
                    ...
                    new PortfolioProject
                    {
                        ...
                        ImageUrl = "/media/placeholders/project-uiux.webp",
                        GalleryJson = JsonGallery(("image", "/media/placeholders/project-uiux.webp", "Neutral UI UX placeholder for Android paraphrasing app", "Replace with wireframe and prototype screenshots.")),
                    ...
                    new PortfolioProject
                    {
                        ...
                        GalleryJson = JsonGallery(("image", "/media/placeholders/project-creative.webp", "Neutral creative project placeholder for game prototype", "Replace with gameplay clip, UI screens, or safe prototype screenshots.")),
                    ...
                    new PortfolioProject
                    {
                        ...
                        GalleryJson = JsonGallery(("image", "/media/placeholders/project-it-data.webp", "Neutral IT data placeholder for L2 support operations", "Replace with a non-sensitive workflow diagram only.")),
                    ...
                    new PortfolioProject
                    {
                        ...
                        ImageUrl = "/media/placeholders/project-it-data.webp",
                        GalleryJson = JsonGallery(("image", "/media/placeholders/project-it-data.webp", "Neutral IT data placeholder for analytics project", "Replace with dashboard screenshot or notebook preview.")),
                    ...
                    new PortfolioProject
                    {
                        ...
                        ImageUrl = "/media/placeholders/project-creative.webp",
                        GalleryJson = JsonGallery(("image", "/media/placeholders/project-creative.webp", "Neutral creative placeholder for print production design", "Replace with approved print samples only.")),
                    ...
                    new PortfolioProject
                    {
                        ...
                        ImageUrl = "/media/placeholders/project-creative.webp",
                        GalleryJson = JsonGallery(("image", "/media/placeholders/project-creative.webp", "Neutral creative placeholder for social media video production", "Replace with approved clips or showreel thumbnail.")),
